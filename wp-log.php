...
function r_log_admin_page(){
    ...
    <div class="wrap">
        ...
        <form role="search" method="get" class="search-form" action="/wp-admin/admin.php" style="display: flex; flex-wrap: wrap; margin-top: 15px;">
            ...
            <input type="submit" class="search-submit" value="Search" style="margin-left: 10px;">
        </form>
        ...
        <?php if ($paged == '') {$paged = 1;} ?>
            ...
            <div class="log-entries-pagination" style="display: flex; flex-wrap: wrap; align-items: center;">
                ...
                <a href="admin.php?page=log.php&paged=<?php echo $paged - 1; ?>"><button <?php echo $paged <= 1 ? 'disabled' : ''; ?>>Newer</button></a>
                <a href="admin.php?page=log.php&paged=<?php echo $paged + 1; ?>"><button <?php echo $paged == $max_pages ? 'disabled' : ''; ?>>Older</button></a>
            </div>
            <?php
